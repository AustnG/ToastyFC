...
import { PRIMARY_COLOR, TEAM_NAME, ACCENT_COLOR, MailIcon, THEME_BLACK, THEME_WHITE } from '../constants';
  ...
  return (
    <div className="space-y-10 py-8">
      <header className="text-center">
        <MailIcon className={`w-12 h-12 text-[${PRIMARY_COLOR}] mx-auto mb-3`} />
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          <div>
            ...
            <input
              ...
              required
              className={`mt-1 block w-full px-3 py-2 border ${formErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-[${ACCENT_COLOR}] focus:border-[${ACCENT_COLOR}] sm:text-sm`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              required
              className={`mt-1 block w-full px-3 py-2 border ${formErrors.subject ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-[${ACCENT_COLOR}] focus:border-[${ACCENT_COLOR}] sm:text-sm`}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              className={`mt-1 block w-full px-3 py-2 border ${formErrors.message ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-[${ACCENT_COLOR}] focus:border-[${ACCENT_COLOR}] sm:text-sm`}
