      ...
      {!isLoading && !error && !upcomingMatch && (
       ...
       <section className="text-center py-12 bg-white rounded-lg shadow-lg">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a href="#/club/about" className={`px-6 py-3 bg-[${ACCENT_COLOR}] text-[${THEME_WHITE}] font-semibold rounded-lg shadow hover:bg-[${ACCENT_COLOR}]/90 transition-colors`}>Learn About Us</a>
          </div>
        </section>
    </div>
  );
