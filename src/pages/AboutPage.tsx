...
import { TEAM_NAME, PRIMARY_COLOR, ACCENT_COLOR } from '../constants';

const AboutPage: React.FC = () => {
  return (
    <div className="space-y-8 py-6">
      <header className="text-center py-6">
        <h1 className={`text-4xl font-bold text-[${PRIMARY_COLOR}]`}>About {TEAM_NAME}</h1>
      </header>

      <Card title="Our Story" className="bg-white">
        ...
        <div className={`mt-6 bg-[${PRIMARY_COLOR}]/10 p-4 rounded-lg border-l-4 border-[${PRIMARY_COLOR}]`} role="note">
          <h3 className={`text-xl font-semibold text-[${PRIMARY_COLOR}] mb-2`}>Fun Fact!</h3>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card title="Our Mission" className="bg-neutral-50">
        ...
        <Card title="Club Values" className="bg-neutral-50">
      ...
      <Card title="Behind The Name: Toasty!" className="bg-white">
       ...
       <Card title="Meet the (Imaginary) Founders" className="bg-white">
