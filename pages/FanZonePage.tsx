...
import { PRIMARY_COLOR, ACCENT_COLOR, TEAM_NAME, SendIcon, SparklesIcon, THEME_WHITE, THEME_BLACK } from '../constants';
...
const FanZonePage: React.FC = () => {
  ...
  const initializeChat = useCallback(async () => {
    ...
    try {
      ...
      setError("Sorry, I'm having a bit of trouble starting up. Please try again later.");
      ...
      <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200 bg-gray-50">
        <div className="flex items-center space-x-3">
          <input
            ...
            placeholder={isLoading ? "Toasty is replying..." : `Ask ${TEAM_NAME} Bot anything...`}
            ...
            disabled={isLoading || !chatInstanceRef.current}
          />
          <button
            type="submit"
            disabled={isLoading || !userInput.trim() || !chatInstanceRef.current}
